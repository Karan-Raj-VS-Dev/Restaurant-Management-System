  ...
  return (
    <div className="admin-auth-layout">
      <div className="admin-auth-hero">
        <div className="admin-auth-badge">React Admin UI</div>
        <h1>Tenant control belongs in its own console.</h1>
        <p>
          This admin page is a standalone single-page application for superusers only. Sign in with the platform username and
          password that live in our own database, then manage tenant properties and employee or user access from here.
        </p>
        <div className="admin-auth-feature-list">
          <StatusPill tone="success">Platform login</StatusPill>
          <StatusPill tone="info">DB-backed users</StatusPill>
          <StatusPill tone="info">Secure cookie APIs</StatusPill>
          <StatusPill tone="warning">Tenant-wide access control</StatusPill>
        </div>
        <div className="admin-auth-seed">
          <strong>Seeded admin identity</strong>
          <span>`kingChef` / `SUPER@secret45`</span>
        </div>
      </div>
      ...
      <SectionCard
        ...
        title="Admin sign in"
        subtitle="Use the tenant admin credentials here. First-login password change stays inside this app flow."
      >
        ...
        {view === "change-password" ? (
          <div className="admin-form">
            <div className="admin-inline-note">
              First-time access uses a temporary password. Update it before entering the admin console.
            </div>
            <label>
              Username
