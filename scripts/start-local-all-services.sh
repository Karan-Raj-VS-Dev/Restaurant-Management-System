...
ensure_file_exists "$ROOT_DIR/services/customer-service/target/customer-service-0.0.1-SNAPSHOT.jar"
...
ensure_file_exists "$ROOT_DIR/services/marketplace-integration-service/target/marketplace-integration-service-0.0.1-SNAPSHOT.jar"
...
ensure_file_exists "$ROOT_DIR/services/reporting-service/target/reporting-service-0.0.1-SNAPSHOT.jar"
...
start_process "customer-service" \
  "$JAVA_BIN" -jar "$ROOT_DIR/services/customer-service/target/customer-service-0.0.1-SNAPSHOT.jar"
...
start_process "marketplace-integration-service" \
  "$JAVA_BIN" -jar "$ROOT_DIR/services/marketplace-integration-service/target/marketplace-integration-service-0.0.1-SNAPSHOT.jar"
...
start_process "reporting-service" \
  "$JAVA_BIN" -jar "$ROOT_DIR/services/reporting-service/target/reporting-service-0.0.1-SNAPSHOT.jar"
...
echo
echo "Local all-services stack started."
echo "Use scripts/status-local-all-services.sh to inspect status."
echo "Use scripts/stop-local-all-services.sh to stop the stack."
